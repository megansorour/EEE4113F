...
void setup(){
  ...
  //     inputMessage2 = "No message sent";
  //   }
  //   Serial.print("Data log values sent.");
  //   request->send(200, "text/plain", "OK");
  // });

  // POSTing updated weight value
  // server.on("/weight", HTTP_POST, [] (AsyncWebServerRequest *request) {
  //   if(request->hasParam(PARAM_INPUT_3, true)) {
  //     postWeight = request->getParam(PARAM_WEIGHT, true)->value();
  //   }
  //   Serial.print("Updated weight value posted.");
  //   request->send(200, "text/plain", "OK");
  // });
